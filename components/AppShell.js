      ...
      <main className="min-h-screen bg-[#080a10] text-slate-100">
        <div className="mx-auto grid min-h-screen w-full max-w-7xl lg:grid-cols-[248px_1fr]">
          ...
          <section className="min-w-0 pb-24 lg:pb-0">
            <header className="sticky top-0 z-30 border-b border-white/10 bg-[#080a10]/82 px-4 py-3 backdrop-blur-xl sm:px-6 lg:hidden"><div className="flex items-center justify-between">{!online ? <span className='text-sm font-semibold text-rose-300'>Connection…</span> : <span className='text-xs text-slate-500'>NearBeat</span>}<Link href="/feed" className="mx-auto flex items-center gap-2 rounded-2xl bg-emerald-400 px-3 py-2 font-black text-slate-950"><Radio size={18} />NearBeat</Link><Link href="/search" className="rounded-full bg-white/10 p-2"><Compass size={19} /></Link></div></header>
